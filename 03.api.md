...
| API Path | Method | 설명 | 사용되는 화면 |
|----------|--------|------|---------------|
| `/admin/dashboard/stats` | GET | 대시보드 통계 (승인대기, 광고주/업체 수) | [대시보드](02_wireframe.md#20-대시보드) |
| `/admin/dashboard/recent-requests` | GET | 최근 승인 요청 목록 (최대 5건) | [대시보드](02_wireframe.md#20-대시보드) |
...
| `/admin/signup-requests/{id}/reject` | POST | 회원가입 거절 (거절 사유 포함) | [회원가입 승인 상세](02_wireframe.md#212-회원가입-승인-상세) |
...
| API Path | Method | 설명 | 사용되는 화면 |
|----------|--------|------|---------------|
| `/agency/dashboard/stats` | GET | 업체 대시보드 통계 (매핑 광고주, 추적 수, 포스팅 수) | [대시보드](02_wireframe.md#30-대시보드) |
| `/agency/dashboard/recent-tracking` | GET | 최근 추적 현황 (최대 5건) | [대시보드](02_wireframe.md#30-대시보드) |
...
| API Path | Method | 설명 | 사용되는 화면 |
|----------|--------|------|---------------|
| `/advertiser/dashboard/stats` | GET | 광고주 대시보드 통계 (매핑 업체, 추적 수, 포스팅 수) | [대시보드](02_wireframe.md#40-대시보드) |
| `/advertiser/dashboard/recent-tracking` | GET | 최근 추적 현황 (최대 5건) | [대시보드](02_wireframe.md#40-대시보드) |
